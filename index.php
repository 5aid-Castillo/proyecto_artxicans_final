...
<div class="d-grid gap-2 d-md-flex justify-content-start">
  <button class="btn btn-secondary me-md-2 mb-2 mt-3 categories-btn" type="button" onclick="location.href='categories.php'"><img src="./assets/utilities/categorias.png" class="categories-icon" alt="categories-icon"> Ir a categorias</button>
